...
import ConfirmPolicy from "@/components/confirm-policy";
import { TextShimmer } from "@/components/text/text-shimmer";
import { Button } from "@/components/ui/button";
import { useRouter } from "next/navigation";

function ConfirmationPolicyPage() {
  ...
  return (
    <div className="font-prompt flex min-h-screen w-full flex-col items-center justify-center gap-6 bg-[#0d0d0d] py-10 text-white">
      <h2 className="font-game-of-squid font-bold lowercase">
        ...
        >
          ข้อกำหนดในการยืนยันสิทธิเข้าร่วมโครงการ
        </TextShimmer>
      </h2>
...
export default ConfirmationPolicyPage;
