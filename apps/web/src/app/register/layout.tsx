...
export default function RegisterLayout({
  ...
  if (!haveUser) {
    return (
      <div className="bg-charcoal-1 flex min-h-screen w-full items-center justify-center text-white">
        <div role="status">
          <svg
            aria-hidden="true"
            className="fill-vermilion h-8 w-8 animate-spin text-gray-600 dark:text-gray-600"
            viewBox="0 0 100 101"
            fill="none"
