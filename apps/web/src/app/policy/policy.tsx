    ...
    <div className="font-noto-sans-thai-looped flex h-full w-full flex-col gap-2">
      ...
      <Article>
        <div className="px-8">
          <ul className="list-disc pl-14">
            <li>
              <span className="font-bold">ข้อมูลส่วนบุคคล </span>
              เช่น ชื่อ นามสกุล อายุ วัน/เดือน/ปีเกิด สัญชาติ เลขประจำตัวประชาชน
              เป็นต้น
            </li>
            <li>
              <span className="font-bold">ข้อมูลการติดต่อ</span> เช่น ที่อยู่
              หมายเลขโทรศัพท์ อีเมล เป็นต้น
            </li>
            <li>
              <span className="font-bold">ข้อมูลบัญชี </span> เช่น
              บัญชีผู้ใช้งาน ประวัติการใช้งาน เป็นต้น
            </li>
            <li>
              <span className="font-bold">หลักฐานแสดงตัวตน </span>
              เช่น สำเนาบัตรประจำตัวประชาชน เอกสารรับรองการเป็นนักเรียน เป็นต้น
            </li>
            <li>
              <span className="font-bold">ข้อมูลอื่นๆ </span>
              เช่น
            ...
            <li>
              <span className="font-bold">ข้อมูลสุขภาพ</span>
            </li>
          </ul>
        </div>
      </Article>
