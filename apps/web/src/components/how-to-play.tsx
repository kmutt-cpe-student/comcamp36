...
export default function HowToChess() {
  ...
  const stepContent = [
    ...
    },
    {
      title: "บทนำ (ต่อ)",
      description:
        "เพื่อแก้โจทย์ข้อนี้ น้องจำเป็นต้องทำความรู้จักรูปแบบการเดินของหมากรุกเบื้องต้น ในที่นี้จะแนะนำการเดินของหมากที่มีในโจทย์ ประกอบด้วย",
    },
    {
      title: "อัศวิน",
    ...
    },
    {
      title: "วิธีการเล่น (1)",
      description:
        "ออกแบบการเดินหมากห่านห้าวหาญ (อัศวิน) เริ่มต้นที่ช่อง b1 เพื่อเก็บแต้มให้มากที่สุด แต่ละช่องจะมีผลตามประเภทและค่าของช่องนั้น ๆ โดยในทุกการเดิน น้องจะถูกหักแต้มออก 10% ของแต้มที่น้องมีอยู่ และจะนับแต้มที่น้องได้ตามแต้มสุดท้ายที่น้องมีอยู่เมื่อเข้าสู่ช่องบ่อน้ำที่สิ้นสุด",
    },
    {
      ...
      description: (
        <div className="space-y-4">
          ...
          <p className="mt-4 text-center text-sm italic text-gray-500">
            (หากน้องเดินหมากเข้าช่องขุมทรัพย์หรือช่องคำอวยพร ช่องนั้นๆ
